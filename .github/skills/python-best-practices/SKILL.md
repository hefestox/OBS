...
description: Provides Python patterns for type-first development with dataclasses, discriminated unions, NewType, and Protocol. Use when shaping domain models, contracts, boundary validation, or type-safe abstractions in Python. Combine with framework-specific skills for Django, FastAPI, or other framework code.
---
