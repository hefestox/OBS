---
name: django-tdd
description: Django testing and TDD workflow with pytest-django, factory_boy, mocking, coverage, and DRF API tests. Use when the task is primarily about test design, test infrastructure, or red-green-refactor loops rather than general Django implementation.
metadata:
    origin: ECC
---
...
# Testing only: never copy this hasher configuration to development or production settings.
PASSWORD_HASHERS = [
