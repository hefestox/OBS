...
description: React performance and rendering guidance for plain React component codebases. Use when writing, reviewing, or refactoring React components, hooks, memoization, or bundle behavior outside of Next.js-specific architecture. Prefer vercel-react-best-practices for Next.js or App Router patterns.
---
...
Only use this pattern for server-controlled bootstrap data. Never interpolate user-controlled content into `dangerouslySetInnerHTML`.
