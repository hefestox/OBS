...
description: This skill is for interface design in dashboards, admin panels, apps, tools, settings, and interactive product surfaces. Use to shape interface direction, hierarchy, density, and visual language for UX-oriented product work. NOT for marketing design such as landing pages, campaigns, or brand sites.
---
