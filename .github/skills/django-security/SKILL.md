...
description: Django-specific security hardening for authentication, permissions, CSRF, XSS, secure settings, and deployment reviews. Use when the main task is protecting or auditing a Django app, not when implementing generic Django features.
metadata:
    origin: ECC
---
...
CSP_STYLE_SRC = "'self' 'nonce-random123'"
