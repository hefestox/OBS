---
name: best-practices
description: Apply generic web development best practices for compatibility, baseline security hygiene, and code quality. Use for broad modernization or audit tasks when no framework-specific skill is a better fit. Prefer dedicated security or framework skills for deeper hardening.
license: MIT
metadata:
